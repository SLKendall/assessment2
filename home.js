...
const canWeDeliver = (zipCode) => { 
    ...
    if (zipCode === deliveryAreaZipCodes[i]){
        return console.log("You are elligible for delivery")
    } 
}
return console.log("Sorry, you aren't in our delivery zone")
}
...
const discChange = deals[0].title.replace("15", "10") 
...
//CODE HERE
const discChange2 = deals[1].desc.replace("March", "April").trim()

console.log(discChange2)